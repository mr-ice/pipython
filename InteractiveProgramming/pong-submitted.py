#http://www.codeskulptor.org/#user39_U98i0RTyWV_0.py
...
def spawn_ball(direction):
    ...
    # 10 degrees above 90 or 180 is pretty flat.  55 degrees above
    # 90 or 180 is pretty steep.  Seems like a reasonable range since
    # we don't have any mechanism to change it once it's on its course.
